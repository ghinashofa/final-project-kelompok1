...
export default function TableBudgeting({ transactions, setTransactions }) { // Menggunakan default parameter
        ...
        <div className="px-4 sm:px-6 lg:px-8 mt-2 bg-white rounded-2xl shadow-custom-combined p-6">
            <div className="sm:flex sm:items-center">
                ...
                <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <ModalFormBudgeting transactions={transactions} setTransactions={setTransactions} />
                </div>
            </div>

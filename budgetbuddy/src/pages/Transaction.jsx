            ...
            >
              ...
              <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                <div className="flex h-16 shrink-0 items-center">
                  <img alt="BudgetBuddy" src={logo} className="h-8 w-auto" />
                </div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
            <div className="flex h-16 shrink-0 items-center gap-3">
              ...
              <p className="logo font-semibold text-lg">BudgetBuddy</p>
            </div>
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
            ...
            >
              <div className="relative flex flex-1 flex-col">
                ...
                <p className="text-sm font-normal text-[#AEAEAE]">
                  Take a look at your latest transactions and financial trends.
                </p>
              </div>
            ...
            <div className="px-4 sm:px-6 lg:px-8">
              ...
              {loading ? (
                ...
                <div className="flex flex-col md:flex-row gap-5">
                  <PieCharts transaction={transactions} />
                  <TableTransaction
